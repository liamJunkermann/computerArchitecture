...
ARCHITECTURE Behavior OF register_file IS
  ...
  SIGNAL reg0_q, reg1_q, reg2_q, reg3_q, reg4_q, reg5_q, reg6_q, reg7_q, reg8_q, reg9_q, reg10_q, reg11_q, reg12_q, reg13_q, reg14_q, reg15_q, reg16_q, reg17_q, reg18_q, reg19_q, reg20_q, reg21_q, reg22_q, reg23_q, reg24_q, reg25_q, reg26_q, reg27_q, reg28_q, reg29_q, reg30_q, reg31_q, reg32_q, data_src_mux_out, src_reg : STD_LOGIC_VECTOR(31 DOWNTO 0);
...
BEGIN
  ...
  dest_decoder : decoder_6to33 PORT MAP(
    s(0) => dest_d(0),
    s(1) => dest_d(1),
    s(2) => dest_d(2),
    s(3) => dest_d(3),
  ...
  mux33_32bit_a : mux33_32bit PORT MAP(
    s(0) => addr_a(0),
    s(1) => addr_a(1),
    s(2) => addr_a(2),
    s(3) => addr_a(3),
  ...
  mux33_32bit_b : mux33_32bit PORT MAP(
    s(0) => addr_b(0),
    s(1) => addr_b(1),
    s(2) => addr_b(2),
    s(3) => addr_b(3),
